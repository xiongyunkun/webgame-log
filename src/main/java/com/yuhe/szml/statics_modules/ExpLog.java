...
public class ExpLog extends AbstractStaticsModule {

	private static final String[] LOG_COLS = { "Uid", "Urs", "Name", "OrgExp", "ExpChange", "CurExp", "OrgLevel", "CurLevel", "Reason" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Urs", "Name", "OrgExp", "ExpChange", "CurExp", "OrgLevel", "CurLevel", "Reason", "Time" };
