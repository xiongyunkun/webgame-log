...
public class MountLevelLog extends AbstractStaticsModule {

	private static final String[] LOG_COLS = { "Uid", "Name", "MountID", "TransID", "OrgEvoLevel", "NewEvoLevel", "OrgExp",
			"NewExp", "Consumes" };
	private static final String[] DB_COLS = { "HostID", "Uid", "Name", "MountID", "TransID", "OrgEvoLevel", "NewEvoLevel", "OrgExp",
